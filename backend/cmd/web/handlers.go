...
func (cfg *Config) home() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			cfg.ErrorLog.Printf("Unable to encode latest snippets: %v", latest)
		}
	}
}
...
func (cfg *Config) wsInfo() http.HandlerFunc {
    return func(w http.ResponseWriter, r *http.Request) {
        var ids []uuid.UUID
        ...
        if err != nil {
            cfg.ErrorLog.Printf("error encoding wsinfo err: %v", err)
        }
    }
}
